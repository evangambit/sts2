...
| `CF32ERF3DH-a8.json` | Underdocks | 99 | **diverges** at step 1 — the Lost Coffer Neow blessing opens a rewards screen the emulator turns straight into a card reward. Also an enemy announcing no attack at step 68 where the emulator announces 12. Uninvestigated. |
